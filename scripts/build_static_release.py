...
def main() -> None:
    ...
    index = re.sub(r'href="/static/round74-game\.css(\?[^"]*)?"', r'href="static/round74-game.css\1"', index)
    ...
    index = re.sub(r'src="/static/round74-game\.js(\?[^"]*)?"', r'src="static/round74-game.js\1"', index)
    config = """
    <script>
