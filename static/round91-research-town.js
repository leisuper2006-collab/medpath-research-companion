(() => {
    ...
    return `
      <div class="r77-town is-concept-mode" data-r77-root>
        ...
        <aside class="r77-left-panel" data-r77-left-panel>
          <div class="r77-left-head"><b>科研贡献榜</b><span class="r77-info">i</span></div>
        ...
        <nav class="r77-rail"><button data-r77-action="tasks"><span>★</span><small>任务</small></button><button data-r77-action="catalog"><span>▣</span><small>背包</small></button><button data-r77-action="skill"><span>⚡</span><small>技能</small></button><button data-r77-action="cases"><span>▤</span><small>案例</small></button><button data-r77-action="tools"><span>⌘</span><small>工具</small></button><button data-r77-action="decor"><span>♣</span><small>装饰</small></button><button data-r77-action="rank"><span>☺</span><small>好友</small></button><button data-r77-action="achieve"><span>🏆</span><small>成就</small></button></nav>
        <button class="r77-mobile-decor-fab" data-r77-action="decor" type="button" onclick="window.medpathR77Action && window.medpathR77Action('decor')"><span>♣</span><b>装饰商店</b></button>
        ...
        <div class="r77-dock"><button data-r77-action="explore" onclick="window.medpathR77Action && window.medpathR77Action('explore')"><span>◉</span><small>探索</small></button><button data-r77-action="build" onclick="window.medpathR77Action && window.medpathR77Action('build')"><span>🔨</span><small>建造</small></button><button data-r77-action="decor" onclick="window.medpathR77Action && window.medpathR77Action('decor')"><span>♣</span><small>装饰</small></button><button data-r77-action="shop" onclick="window.medpathR77Action && window.medpathR77Action('shop')"><span>▥</span><small>商店</small></button><button data-r77-action="warehouse" onclick="window.medpathR77Action && window.medpathR77Action('warehouse')"><span>▤</span><small>仓库</small></button><button data-r77-action="map" onclick="window.medpathR77Action && window.medpathR77Action('map')"><span>▧</span><small>地图</small></button></div>
        ...
        <section class="r77-concept-drawer" data-r77-drawer>
          <header>
            ...
            <button data-r77-close type="button">×</button>
          </header>
  ...
  function handleAction(action) {
    ...
    if (["catalog", "build", "shop", "warehouse"].includes(action)) {
      ...
      state.drawer = true;
      state.toast = state.editing
        ? "编辑模式已开启：可拖动建筑，也可在商店下方选择装饰，把科研小岛布置成自己的空间。"
        : "编辑模式已关闭：建筑位置已保存到本地；装饰商店仍可继续选择摆件。";
      persist();
    } else if (action === "like") {
      state.likes += 1;
      state.points += 8;
      ...
      r?.querySelector("[data-r77-left-panel]")?.classList.toggle("is-open-mobile");
